...
export const MindNodeComponent = memo((props: NodeProps<MindNodeData>) => {
  ...
  const { id, data, selected } = props; // Added ID destructuring
  ...
  // REVISED ZOOM BREAKPOINTS: Keep detailed view longer
  // Level 3 (Blob): Zoom < 0.25 (Very far)
  // Level 2 (Simple/Pill): Zoom 0.25 - 0.6 (Medium far)
  // Level 1 (Detail): Zoom >= 0.6 (Close to Medium)
  if (zoom < 0.25) {
