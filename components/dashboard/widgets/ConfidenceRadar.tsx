...
import { RadarDataPoint, ObesityLevel } from '../../../types';
...
export function ConfidenceRadar({ data, score, obesityLevel, theme }: ConfidenceRadarProps) {
  // Logic (useMindoStore) removed. Now purely relies on props.

  return (
     <GlassCard className="p-6 h-full flex flex-col relative">
