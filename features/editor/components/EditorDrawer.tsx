                ...
                <div className="flex-[0.3] bg-slate-50/80 dark:bg-[#02040A] flex flex-col min-h-0 overflow-y-auto border-l border-white/5">
                    ...
                    <div className="p-6 mt-auto bg-slate-100/50 dark:bg-white/[0.02]">
                        <div className="flex flex-col gap-2 text-[10px] text-slate-400 font-mono mb-4">
                            <div className="flex items-center gap-2"><Clock size={10} /> Created: {format(new Date(node.data.created_at || new Date()), 'MMM d, yyyy HH:mm')}</div>
                            <div className="flex items-center gap-2"><Clock size={10} /> Updated: {format(new Date(node.data.updated_at || new Date()), 'MMM d, yyyy HH:mm')}</div>
