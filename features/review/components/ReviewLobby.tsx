      ...
      <div className="max-w-2xl w-full">
        <AnimatedCard className="text-center mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-lg">
            Fortaleça conexões via Recordação Ativa.
          </p>
        </AnimatedCard>
        ...
        <AnimatedCard className="space-y-4 mb-10">
          ...
          <button
            ...
            className={`w-full p-5 rounded-2xl border transition-all duration-300 group ${selectedMode === 'daily'
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-left flex-1">
                ...
                <div className="text-sm text-slate-500 dark:text-slate-400">
                  {reviewDueCount} itens pendentes
                </div>
              </div>
              {reviewDueCount > 0 && (
          ...
          <button
            ...
            className={`w-full p-5 rounded-2xl border transition-all duration-300 ${selectedMode === 'custom_tags'
                ? 'bg-indigo-50 dark:bg-mindo-primary/20 border-indigo-200 dark:border-mindo-glow/50 shadow-lg dark:shadow-[0_0_20px_rgba(107,33,168,0.2)]'
                : 'bg-white dark:bg-white/5 border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:bg-white/10 dark:hover:border-white/20 shadow-sm'
              }`}
          >
            ...
            <div className="ml-20 flex flex-wrap gap-2 animate-fade-in">
              {allTags.map((tag) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-mono border transition-all ${selectedTags.includes(tag)
